...
namespace APIAutomationFramework.Tests.PUT
{
    [TestClass]
    public class PUTEndpoints
    {
        ...
        public void PutUpdateUser()
        {
            ...
            object body = new { name = "morpheus", job = "zion resident" };
            var request = requestBuilder.CreateRequest("/api/users/2", Method.Put, headers: headers, body: body);
